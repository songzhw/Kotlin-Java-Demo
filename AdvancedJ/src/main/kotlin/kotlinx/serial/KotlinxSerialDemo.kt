...
//    val resp = """{"code":100,"msg":"success","payload":{"imgUrl":"http://192.168.2.26:8899/images/splash/splash3.jpg"}}"""
     ...
     */
    val resp3 = JSON.stringify(Response(200, "sueess", date))// 调用了Serializer.save()方法
    println(resp3)

    val resp4 = JSON.parse<Response>(resp3) // 调用了Serializer.load()方法, 将string改成我们需要的Date
    println("${resp4.code}, ${resp4.msg}, ${resp4.timestamp}")
}
