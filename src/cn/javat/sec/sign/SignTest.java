package cn.javat.sec.sign;

import cn.javat.Util;
...
public class SignTest {
    ...
    public void getKeyPair()  throws Exception{
        File file = new File("src/cn/javat/sec/cert/test12.p12");
    ...
    public void sign()  throws Exception{
        File file = new File("src/cn/javat/sec/cert/bbb.cer");
        InputStream is = new FileInputStream(file);
    ...
    public void verify()  throws Exception{
        ...
        File file2 = new File("src/cn/javat/sec/cert/bbb.cer");
